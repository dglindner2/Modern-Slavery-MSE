...
These are very restrictive and unlikely to be satisfied in reality. However, when using more than two lists, we can account for dependence between the lists by also modelling and estimating interaction terms. 
