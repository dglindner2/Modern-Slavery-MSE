...
The `Rcapture` package also allows us to fit all models with possible interaction terms. It limits the number of lists to $5$, however, as otherwise the number of possibilities is too large.
